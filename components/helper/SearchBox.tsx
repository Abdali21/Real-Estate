...
const SearchBox = () => {
    return (
        <div className="w-full md:w-[80%] mx-auto bg-white h-[4rem] sm:h-[5rem] flex px-4 sm:px-8
                    flex-col rounded-lg justify-center"
        >
            <div className="flex items-center justify-between h-full">
                <input type="text" placeholder="Enter an adresse, city, or ZIP to buy"
                    className="sm:flex-[0.8] h-[60%] bg-gray-100 rounded-lg 
                               outline-none px-4  placeholder:text-sm block"
                />
                <div className="flex items-center flex-[0.2] ml-8 space-x-6">
                    ...
                    <div className="w-12 h-12 bg-rose-600 flex items-center hover:bg-rose-800 
