...
import { BiLinkExternal, BiSolidPlusSquare } from "react-icons/bi";
    ...
    return (
        <div className="bg-white overflow-hidden group rounded-lg cursor-pointer shadow-lg">
            <div className="relative">
                ...
                <div className="flex items-center space-x-1 px-6 absolute left-4 top-4 py-2 text-sm bg-rose-600
                                w-fit text-white rounded-md font-bold ">
                    <MdElectricBolt />
                    <span>Featured</span>
                </div>
            </div>
            <div className="p-5 ">
                ...
                <div className="flex items-center mt-6 w-full justify-between lg:w-[80%]">
